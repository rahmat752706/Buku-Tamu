<?php 
  $id = $_GET["id"];
  $details = $mysqli->query("SELECT * FROM daftar_tamu WHERE id ='$_GET[id]'");
  ...
  <div class="col-md-8">
    <div class="container">
      <div class="row justify-content-center">
        <a href="?page=tamu" class="btn btn-default" style="margin-left: 20px;">kembali</a></button>
          <h2 class="bg-light p-2 rounded  text-center text-dark" style="color: black;"> Data Tamu </h2>
          <hr class="my-3">
          <!-- <div class="text-center">
            <img src="images/tamu/<?= $d["gambar"]; ?>" width="200" class="img-thumnail mt-3"> 
          </div>
          <h6 class="text-dark text-center mt-3" style="font-size: 16px; margin-top: 20px;">NAMA  : <?= $d["nama"]; ?></h6>
          <h6 class="text-dark text-center" style="font-size: 16px;">NO HP  : <?= $d["no_hp"]; ?></h6>
          ...
          <h6 class="text-dark text-center" style="font-size: 16px;">KEPERLUAN  : <?= $d["keperluan"]; ?></h6>
          <h6 class="text-dark text-center" style="font-size: 16px;">TANGGAL  : <?= $d["tanggal"]; ?></h6> -->
          <style>
    html {
  font-size: 17px;
...
.front-side, .back-side {
    ...
    margin: 20px auto;
    overflow: hidden;
    box-shadow: 2px 5px 15px 0px #57252594;
...
h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6 {
  ...
  <div class="front-side" style="width: 800px; height: 500px;">
        ...
        <div class="info-grid">
            <div class="name">
              <h4><?php echo strtoupper($d["nama"]); ?> (<?php echo $d["jk"]; ?>)</h4>  
              <img src="images/tamu/<?= $d["gambar"]; ?>" width="200" class="img-thumnail mt-3" style="max-width:100%; height:auto;">
            ...
            <div class="emailId">
                ...
                <!-- <p class="email">yourusername@
                    ...
                    <p class="email"><?php echo $d["email"]; ?></p>
                <!-- <p class="web"> -->
                    <!-- <strong></strong>.yourwebsite. -->
                    <!-- <strong>com</strong> -->
                <!-- </p> -->
            </div>
        </div>
    </div>
    <div class="back-side" style="width: 800px; height: 500px;">
        <div class="color-grid">
            <div class="black"></div>
            <div class="red1"></div>
            <div class="red2"></div>
        ...
        <div class="name-tag">
            <h3>
                <strong><?php echo strtoupper($d["keperluan"]); ?></strong>
            </h3>
